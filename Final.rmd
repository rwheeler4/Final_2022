...
The p value is 0.00000000002645, which is significantly less than .05; therefor, we must reject the null hypothesis.
...
The p value is 0.0009484 < .05; therefor, we must reject the null hypothesis.
...
The p-value is 1.642e-09, which is less than .05, meaning we must once again, reject the null hypothesis. 
...
The p-value for the Druggie subgroup is 2.886e-08, which is many orders of magnitude less than .05, so we must reject the null hypothesis.
